...
# Note: The syntax highlighting in Learn may make it look like the = sign in name= is separate from the name of the definition, but it is not. The = is a necessary piece. Adding it in allows us to write kanye.name = "Yeezy" but this is a bit of syntatic sugar. Writing kanye.name=("Yeezy") is also a valid way to use this setter method.
